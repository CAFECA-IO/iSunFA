...
-- 9. 重新建立外鍵約束
ALTER TABLE "line_item" ADD CONSTRAINT "line_item_account_id_fkey" 
    FOREIGN KEY ("account_id") REFERENCES "account"("id") 
    ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "account" ADD CONSTRAINT "account_parent_code_fkey" 
    FOREIGN KEY ("parent_code") REFERENCES "account"("code") 
    ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "account" ADD CONSTRAINT "account_root_code_fkey" 
    FOREIGN KEY ("root_code") REFERENCES "account"("code") 
    ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- 13.2 確認所有記錄都有值後，再加上 NOT NULL 約束
ALTER TABLE account ALTER COLUMN parent_id SET NOT NULL;
ALTER TABLE account ALTER COLUMN root_id SET NOT NULL;

-- 14. 新增 note 選填欄位
-- ALTER TABLE account ADD COLUMN note VARCHAR(255);
ALTER TABLE account ADD COLUMN note TEXT;

-- 15. 修改 parent 和 child 關係，改用 id 引用
-- 移除原有的外鍵約束
ALTER TABLE line_item DROP CONSTRAINT line_item_account_id_fkey;
ALTER TABLE account DROP CONSTRAINT account_parent_code_fkey;
ALTER TABLE account DROP CONSTRAINT account_root_code_fkey;
...
-- DropForeignKey
ALTER TABLE "associate_line_item" DROP CONSTRAINT "associate_line_item_associate_voucher_id_fkey";

-- AlterTable
ALTER TABLE "associate_line_item" RENAME COLUMN "associate_voucher_id" TO "associate_voucher_id_new";

-- AlterTable
ALTER TABLE "company_setting" ADD COLUMN "country_code" TEXT NOT NULL DEFAULT 'tw';

-- AlterTable
ALTER TABLE "event" RENAME COLUMN "frequency" TO "frequency_new";

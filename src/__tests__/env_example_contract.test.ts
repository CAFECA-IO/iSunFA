...
const RATE_LIMIT_KEYS = [
  ...
  // Info: (20260825 - Julian) 小鈴鐺的兩個桶（計畫書 D2）
  "NOTIFICATION_RL_READ_PER_MINUTE",
  "NOTIFICATION_RL_READ_PER_DAY",
  "NOTIFICATION_RL_WRITE_PER_MINUTE",
  "NOTIFICATION_RL_WRITE_PER_DAY",
];

...
export async function getSystemHardwareInfo(): Promise<{
  osType: string;
  osRelease: string;
  arch: string;
  cpuModel: string;
...
export async function getRunningContainers(): Promise<{
  success: boolean;
  output?: string;
  error?: string;
}> {
...
export async function startDockerEngine(): Promise<{
  success: boolean;
  output?: string;
  error?: string;
}> {
...
export async function startDockerCompose(): Promise<{
  success: boolean;
  output?: string;
  error?: string;
}> {

  ...
  return (
      <div className="group relative w-32 h-32 bg-white rounded-2xl border border-gray-200 flex flex-col items-center justify-center p-2 cursor-zoom-in hover:shadow-lg transition-all">
        <div className="bg-gray-50 rounded-xl w-full h-full flex items-center justify-center mb-1 group-hover:bg-orange-50 transition-colors">
          <Paperclip className="text-gray-400 group-hover:text-orange-500 transition-colors" size={24} />
        </div>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <article className="space-y-12">
          ...
          <div className="bg-gray-50 rounded-3xl p-8 border border-gray-100 italic relative">
            ...
            {/* 附件預覽 */}
           {data.attachments && data.attachments.length > 0 && <div className="mt-6 flex flex-wrap gap-3">
        ...
        <section className="bg-linear-to-br from-orange-50 to-amber-50 rounded-[2.5rem] p-10 border border-orange-100 relative overflow-hidden shadow-sm">
          ...
          <header className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h2 className="text-xl font-extrabold text-orange-900">AccounTalk AI</h2>
              <p className="text-xs text-orange-600 font-medium">模型版本：v2.1-Standard • 經過專家驗證</p>
            </div>
          </header>
          ...
          <article className="prose prose-orange max-w-none prose-p:text-gray-800 prose-strong:text-orange-900 prose-li:text-gray-700">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-1">法條依據</h3>
                  <p>依據《加值型及非加值型營業稅法》第 33 條規定，營業人以進項稅額扣抵銷項稅額者，應具備載明其名稱、地址及統一編號之憑證。</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-1">執行建議</h3>
                  <p>請確保發票上載明貴司統編，並確認屬於營業必要支出。若為餐飲業，需注意交際費限額問題。</p>
                </div>
              </div>
            </div>
          </article>
          ...
          <footer className="mt-10 pt-8 border-t border-orange-200/50 flex flex-wrap items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <button className="flex items-center gap-2 bg-orange-600 text-white px-5 py-2.5 rounded-2xl font-bold shadow-md shadow-orange-200 hover:bg-orange-500 transition-all active:scale-95">
                <ThumbsUp size={18} fill="currentColor" />
                <span>{data.countOfLike} 人贊同</span>
              </button>
              <button className="flex items-center gap-2 bg-white text-gray-400 px-5 py-2.5 rounded-2xl font-bold border border-gray-100 hover:bg-gray-50 transition-all">
                <ThumbsDown size={18} />
                <span>不準確</span>
              </button>
            </div>
        ...
        <section className="pt-20">
          ...
          {/* 發表評論 Input */}
          <div className={`mb-10 transition-all duration-300 overflow-hidden ${isShowInput ? 'max-h-60 opacity-100' : 'max-h-0 opacity-0'}`}>
            <div className="flex gap-4 p-6 rounded-4xl bg-orange-50/50 border border-orange-100 shadow-inner">
              ...
              <div className="flex-1 space-y-3">
                <textarea
                  ...
                  className="w-full bg-white border border-orange-100 rounded-2xl p-4 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all placeholder:text-gray-300 min-h-[100px] resize-none shadow-sm"
                />
          ...
          <div className="space-y-6">
            {/* 會計師評論範例 */}
            <div className="group relative flex gap-5 p-6 rounded-3xl bg-white border border-gray-100 hover:border-orange-200 hover:shadow-xl hover:shadow-orange-50 transition-all">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <span className="font-extrabold text-gray-900">林會計師 (CPA)</span>
                  <span className="text-[10px] bg-blue-50 text-blue-700 px-2.5 py-1 rounded-full font-bold uppercase tracking-wider">專業認證</span>
                ...
                <div className="flex items-center gap-4 pt-2">
                  <button className="text-xs font-bold text-gray-400 hover:text-orange-500">回覆</button>
                  <button className="text-xs font-bold text-gray-400 hover:text-orange-500">讚 (8)</button>
                </div>
              </div>
            </div>

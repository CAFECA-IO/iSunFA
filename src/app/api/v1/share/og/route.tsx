...
export async function GET(request: Request) {
  try {
    ...
    const shareRecord = await shareRepo.findTokenUnique({
      ...
      >
        ...
        <div
          style={{
            ...
            height: "12px",
            background:
              "linear-gradient(90deg, #EA580C 0%, #F97316 50%, #FDBA74 100%)",
            zIndex: 10,
          }}
        />
        ...
        >
            ...
            {displayScore ? (
              <div
                style={{
                  ...
                  flexShrink: 0,
                  boxShadow:
                    "0 20px 25px -5px rgba(234, 88, 12, 0.1), 0 8px 10px -6px rgba(234, 88, 12, 0.1)",
                }}
              >
                <span
                  style={{
              ...
              >
                ...
                >
                  ...
                  />
                  <path
                    d="M100 65 L120 55 L140 65 L135 100 C125 115 105 125 105 125 C105 125 90 115 85 100 Z"
                    fill="#FFFFFF"
                    stroke="#EA580C"
                    strokeWidth="4"
                  ...
                  />
                  <path
                    d="M35 45 L39 33 L45 45 L55 49 L45 54 L39 65 L35 54 L25 49 Z"
                    fill="#FDBA74"
                  />
                </svg>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
              <span
                style={{ fontSize: "24px", color: "#1A2E50", fontWeight: 700 }}
              >
                {t.ui.slogan}
              </span>
              <div
              ...
              />
              <span
                style={{ fontSize: "24px", color: "#6B7280", fontWeight: 600 }}
              >
                {t.ui.subSlogan}
              </span>
            </div>

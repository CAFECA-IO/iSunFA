// Info: (20260720 - Emily) 憑證聯動端點(#53):列出帳本可匯入碳盤查的 EsgRecord 活動數據
// Info: (20260720 - Emily) 純端口:授權 → 限流(READ,無 LLM) → 帳本閱覽裁決 → service
// Info: (20260720 - Emily) 亦為 #54 證據鏈元件的實時資料來源(同一權限、同一形狀)
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Info: (20260720 - Emily) 帳本閱覽裁決(#52 同語意、同錯誤碼):非帳本成員一律拒絕

...
export async function GET(
  request: NextRequest,
  { params }: { params: Promise<{ account_book_id: string; coefficient_id: string }> },
) {
  try {
    ...
    const { account_book_id: accountBookId, coefficient_id: coefficientId } = await params;
    ...
    const formattedCoefficient: ICoefficient = {
      ...coefficient,
      category: !!coefficient.accountBookId ? CoefficientCategory.CUSTOM : CoefficientCategory.STANDARD,

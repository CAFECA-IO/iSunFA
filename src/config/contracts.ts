...
export const RPC_URL =
  process.env.NEXT_PUBLIC_RPC_URL || "https://mainnet.isuncoin.com";
...
export const CONTRACT_ADDRESSES = {
  ...
  TRUSTED_ISSUERS_REGISTRY: (process.env
    .NEXT_PUBLIC_TRUSTED_ISSUERS_REGISTRY_ADDRESS ||
    "0x2083c0c2ECd93EF6D185ce69cFFf8EF54cAd5aEE") as Address,
  CLAIM_TOPICS_REGISTRY: (process.env
    .NEXT_PUBLIC_CLAIM_TOPICS_REGISTRY_ADDRESS ||
    "0x176D9F5FA35859B9Cbab9b1B0660D5379f6dE3A2") as Address,
  IDENTITY_IMPLEMENTATION: (process.env
    .NEXT_PUBLIC_IDENTITY_IMPLEMENTATION_ADDRESS ||

...
export interface IAccountBookEntity {
  id: number;
  teamId: number;
  userId: number;
  imageId: string;
...
export interface IAccountBook {
  ...
  filingFrequency?: FILING_FREQUENCY | null; // Info: (20250423 - Liz) 申報頻率
  filingMethod?: FILING_METHOD | null; // Info: (20250423 - Liz) 總繳種類
  declarantFilingMethod?: DECLARANT_FILING_METHOD | null; // Info: (20250423 - Liz) 申報方式

  declarantName?: string | null; // Info: (20250423 - Liz) 申報人姓名
  declarantPersonalId?: string | null; // Info: (20250423 - Liz) 申報人身分證字號
  declarantPhoneNumber?: string | null; // Info: (20250423 - Liz) 申報人電話號碼

  agentFilingRole?: AGENT_FILING_ROLE | null; // Info: (20250423 - Liz) 申報代理人的角色，有三種：會計師(稅務代理人)、記帳士、記帳及報稅代理人
  licenseId?: string | null; // Info: (20250506 - Liz) 申報代理人的證書字號、登錄字號
}

...
export type IAPIName =
  ...
  | 'VOUCHER_DELETE_V2'
  | 'VOUCHER_RESTORE_V2'
  | 'LIST_CERTIFICATE_RC2_INPUT'
  | 'CREATE_CERTIFICATE_RC2_INPUT'
  | 'GET_CERTIFICATE_RC2_INPUT'
  | 'UPDATE_CERTIFICATE_RC2_INPUT'
  | 'DELETE_CERTIFICATE_RC2_INPUT'
  | 'LIST_CERTIFICATE_RC2_OUTPUT'
  | 'CREATE_CERTIFICATE_RC2_OUTPUT'
  | 'GET_CERTIFICATE_RC2_OUTPUT'
  | 'UPDATE_CERTIFICATE_RC2_OUTPUT'
  | 'DELETE_CERTIFICATE_RC2_OUTPUT'
  ...
  | 'LIST_ACCOUNT_BOOK_INFO_BY_USER_ID'

...
const CompanyListModal: React.FC<CompanyListModalProps> = ({ toggleModal }) => {
  ...
  return (
    <main className="fixed inset-0 z-70 flex items-center justify-center bg-black/50">
      <div className="ml-250px flex max-h-90vh w-90vw max-w-920px flex-col rounded-lg bg-surface-neutral-surface-lv2">
        ...
        <section className="flex flex-col gap-lv-5 px-40px py-16px">
          ...
          <div className="table w-full overflow-hidden rounded-sm bg-surface-neutral-surface-lv2 shadow-normal_setting_brand">
            ...
            <div className="table-row-group">
              ...
              {companies.map((company, index) => (
                ...
                >
                  ...
                  <div className="relative table-cell text-left align-middle">

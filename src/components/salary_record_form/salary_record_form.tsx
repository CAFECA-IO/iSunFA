...
const SalaryRecordForm = () => {
  ...
  // ToDo: (20240715 - Julian) Implement dropdown
  ...
  return (
    <div className="flex w-full flex-col">
      ...
      <div className="flex flex-col gap-16px">
        <h1 className="text-4xl font-semibold text-text-neutral-secondary">Salary Record</h1>
      ...
      <div className="mt-40px flex flex-col">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 text-sm">
            <Image src="/icons/record.svg" width={16} height={16} alt="ticket_icon" />
            <p>Create new payroll records</p>
          </div>
          <hr className="flex-1 border-lightGray3" />
        </div>
        {/* Info: (20240715 - Julian) Form */}
        <form className="mt-40px flex flex-col gap-y-40px">
          ...
          <div className="flex items-end gap-x-16px">
            ...
            <div className="flex w-full flex-col items-start gap-8px md:w-200px">
              ...
              <div
                ...
                className="flex w-full items-center rounded-sm border border-input-stroke-input bg-input-surface-input-background px-12px py-10px hover:cursor-pointer hover:border-input-stroke-selected"
              >

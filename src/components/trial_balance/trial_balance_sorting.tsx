...
const TrialBalanceSorting: React.FC<ISortingButtonProps> = ({
  string,
  sortOrder,
  setSortOrder,
  handleReset,
  ...
  return (
    ...
    >
      ...
      <p
        className={`${sortOrder === null ? '' : 'text-text-brand-primary-lv1'} whitespace-nowrap print:whitespace-pre-wrap`}
      >
        {string}
      </p>

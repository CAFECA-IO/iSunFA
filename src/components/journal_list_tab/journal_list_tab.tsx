...
const JournalListTab = () => {
  ...
  const displayedAmount = (
    <div className="flex flex-col gap-8px py-8px text-left font-medium">
      <div className="flex items-center gap-6px">
        ...
        <p className="w-200px text-lightGray4">1141- Accounts receivable</p>
        <p className="text-navyBlue2">
      ...
      <div className="flex items-center gap-6px">
        ...
        <p className="w-200px text-lightGray4">1113- Cash in banks</p>
        <p className="text-navyBlue2">
          1,785,000 <span className="text-lightGray4">TWD</span>
        </p>
      </div>
  ...
  const journalItem = (
    <tr className="border-b border-lightGray6 text-center align-middle text-lightGray4">
      ...
      <td className="px-16px text-left font-medium text-darkBlue">20240417-001</td>
    </tr>
  );
    ...
    <table className="my-20px w-full border border-lightGray6">
      ...
      <thead>
        <tr className="bg-white text-left text-sm text-lightGray4">
          ...
          <th className="px-16px">Voucher No</th>
        </tr>
      </thead>

      {/* Info: (20240418 - Julian) Body */}
      <tbody>{journalItem}</tbody>
    </table>
  );

...
const MilestoneCalendar = ({
  ...
  const weekdayTitle = [
    t('alpha:DATE_PICKER.SUN'),
    t('alpha:DATE_PICKER.MON'),
    t('alpha:DATE_PICKER.TUE'),
    t('alpha:DATE_PICKER.WED'),
    t('alpha:DATE_PICKER.THU'),
    t('alpha:DATE_PICKER.FRI'),
    t('alpha:DATE_PICKER.SAT'),
  ];

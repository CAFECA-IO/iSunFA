              ...
              >
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 focus:ring-2 focus:ring-orange-500 disabled:opacity-50"
                    disabled={disabled}
                  />
                  <button
                  ...
                  <div className="flex-1">
                    <label className="mb-1 block text-xs text-gray-500">
                      ...
                      <input
                        ...
                        className="mt-1 w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 focus:ring-2 focus:ring-orange-500 disabled:opacity-50"
                        disabled={disabled}
                      />
                    </label>
                  </div>

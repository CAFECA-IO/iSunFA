...
const ProjectSidebar = ({ projectId }: IProjectDetailPageProps) => {
  ...
  const displayedCompanyName = companyName ? (
    ...
    >
      {/* ToDo: (20240801 - Julian) [Beta] Replace to real project image */}
      {projectId.charAt(0)}
    </Link>
  ) : null;
  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed z-10 hidden h-screen flex-col items-center font-semibold md:flex ${isExpanded ? 'w-240px' : 'w-70px'} bg-surface-neutral-surface-lv2 px-12px pb-40px pt-120px transition-all duration-300 ease-in-out`}
      >
        ...
        <div className="my-16px flex w-full flex-col items-center text-lg">
          ...
          <Link
            ...
            className={`flex w-full items-center gap-8px p-8px ${inDashboard ? 'text-tabs-text-active' : 'text-tabs-text-default'} hover:text-tabs-text-active`}
          >
          ...
          <Link
            ...
            className={`flex w-full items-center gap-8px p-8px ${inContract ? 'stroke-tabs-text-active text-tabs-text-active' : 'stroke-tabs-text-default text-tabs-text-default'} hover:stroke-tabs-text-active hover:text-tabs-text-active`}
          >
            <div className="h-20px w-20px">
              <svg
                width="20"
          ...
          <Link
            href={`${ISUNFA_ROUTE.PROJECT_LIST}/${projectId}/journal/journal_list`}
            className={`flex w-full items-center gap-8px p-8px ${inJournal ? 'stroke-tabs-text-active text-tabs-text-active' : 'stroke-tabs-text-default text-tabs-text-default'} hover:stroke-tabs-text-active hover:text-tabs-text-active`}
          >
            <div className="h-20px w-20px">
              <svg
                width="20"
          ...
          <Link
            ...
            className={`flex w-full items-center gap-8px p-8px ${inReport ? 'stroke-tabs-text-active text-tabs-text-active' : 'stroke-tabs-text-default text-tabs-text-default'} hover:stroke-tabs-text-active hover:text-tabs-text-active`}
          >
            <div className="h-20px w-20px">
              <svg
                width="20"
          ...
          <Link
            ...
            className={`flex w-full items-center gap-8px p-8px ${inSetting ? 'text-tabs-text-active' : 'text-tabs-text-default'} hover:text-tabs-text-active`}
          >
            <div className="h-20px w-20px">
              <FiSettings size={20} />
            </div>
      ...
      <div className="fixed bottom-0 z-10 grid h-72px w-screen grid-cols-5 items-center bg-surface-neutral-surface-lv2 px-16px py-8px shadow-sidebarMobile md:hidden">
        {/* Info: (20240423 - Julian) Dashboard */}
        <Link
          href={`${ISUNFA_ROUTE.PROJECT_LIST}/${projectId}/dashboard`}
          className={`mx-auto p-8px ${inDashboard ? 'text-tabs-text-active' : 'text-tabs-text-default'} hover:text-tabs-text-active`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
        ...
        <Link
          href={`${ISUNFA_ROUTE.PROJECT_LIST}/${projectId}/contracts`}
          className={`mx-auto p-8px ${inContract ? 'stroke-tabs-text-active text-tabs-text-active' : 'stroke-tabs-text-default text-tabs-text-default'} hover:stroke-tabs-text-active hover:text-tabs-text-active`}
        >
          <svg
            width="20"
            height="20"
        ...
        <Link
          href={`${ISUNFA_ROUTE.PROJECT_LIST}/${projectId}/journal/journal_list`}
          className={`mx-auto p-8px ${inJournal ? 'stroke-tabs-text-active text-tabs-text-active' : 'stroke-tabs-text-default text-tabs-text-default'} hover:stroke-tabs-text-active hover:text-tabs-text-active`}
        >
          <svg
            width="20"
            height="20"
        ...
        <Link
          href={`${ISUNFA_ROUTE.PROJECT_LIST}/${projectId}/report`}
          className={`mx-auto p-8px ${inReport ? 'stroke-tabs-text-active text-tabs-text-active' : 'stroke-tabs-text-default text-tabs-text-default'} hover:stroke-tabs-text-active hover:text-tabs-text-active`}
        >
          <svg
            width="20"
            height="20"
        ...
        <Link
          href={`${ISUNFA_ROUTE.PROJECT_LIST}/${projectId}/setting`}
          className={`mx-auto p-8px ${inSetting ? 'text-tabs-text-active' : 'text-tabs-text-default'} hover:text-tabs-text-active`}
        >
          <FiSettings size={20} />
        </Link>
      </div>

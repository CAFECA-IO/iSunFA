    ...
    <div>
      ...
      <section className="relative text-text-neutral-secondary">
        ...
        <div className="relative mb-0 flex items-center pb-1">
          ...
          <div className="absolute bottom-0 left-0 h-[1px] w-full bg-[#314362]"></div>
        </div>
    ...
    <section className="content">
      ...
      <div className="bar_chart_container mt-8 flex items-end justify-between">
        <div className="bar_chart w-1/2 pr-4">
          <div className="relative mb-0 flex items-center pb-1">
            <Image src="/icons/bar_chart_icon.png" alt="" className="mr-2" width={24} height={24} />
            <p className="items-end text-base font-semibold text-[#58667F]">
              2023年度 投資活動 項目佔比
            </p>
            <div className="absolute bottom-0 left-0 h-[1px] w-full bg-[#314362]"></div>
          </div>
      ...
      <div className="mb-[16px] mt-[32px] font-semibold text-surface-brand-secondary">
        <p className="text-base font-semibold">四之一、2023年度上圖組成項目之細項及iSunFa認為：</p>
      </div>
...
const page10 = (
  <div>
    <header className="flex justify-between text-white">
      ...
      <div className="w-[35%] text-right">
        <h2 className="relative whitespace-nowrap border-b-[10px] border-b-surface-brand-primary pr-5 pt-6 text-[20px] font-bold text-surface-brand-secondary-soft">
          Cash Flow Statement
          <span className="absolute bottom-[-20px] right-0 h-[5px] w-[75%] bg-surface-brand-secondary"></span>
        </h2>
      </div>
    ...
    <section className="relative text-text-neutral-secondary">
      ...
      <div className="mb-4 mt-[32px] text-center text-xs font-semibold leading-[20px] tracking-[0.12px] text-surface-brand-secondary">
        ...
        <div className="relative -z-10">
          <Image
            className="absolute right-0 top-[-180px]" // 调整 top 的值来移动图片位置
            src="/logo/watermark_logo.svg"
            alt="isunfa logo"
            width={450}
            height={300}

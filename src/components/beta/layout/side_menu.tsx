...
const PanelLayout = ({
  ...
  return (
    <div ref={panelLayoutRef}>
      ...
      {isPanelOpen && (
        <div className="absolute left-full top-0 h-full w-280px bg-surface-neutral-surface-lv1 px-12px py-32px before:absolute before:left-0 before:top-0 before:h-full before:w-12px before:bg-gradient-to-r before:from-gray-200 before:to-transparent">
          {children}
        </div>
      )}
    </div>

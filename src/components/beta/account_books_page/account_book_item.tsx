...
const AccountBookItem = ({
  ...
  const openChangeInfoModal = (e: React.MouseEvent<HTMLButtonElement>) => {
    setAccountBookToChangeInfo(accountBook);
    closeOptionsDropdown();
    e.stopPropagation(); // Info: (20250407 - Liz) 避免點擊選單時觸發父元素的點擊事件
  };
      ...
      >
        ...
        <section className="flex w-300px flex-auto items-center gap-24px">
          ...
          <div className="flex items-center justify-between gap-8px">
            ...
            <button type="button" onClick={openChangeInfoModal} className="p-8px">

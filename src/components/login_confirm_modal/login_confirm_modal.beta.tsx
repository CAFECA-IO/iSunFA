  ...
  return isModalVisible ? (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="max-h-80vh w-full max-w-xl rounded-xs bg-white p-6 shadow-lg">
        ...
        <div className="h-50vh mb-4 overflow-y-auto rounded-xs border border-navyBlue p-4">
        ...
        <div className="flex justify-end space-x-4">
          ...
          <button
            type="button"
            onClick={onAgree}
            className="rounded-xs bg-navyBlue px-4 py-2 text-white hover:bg-navyBlue2"
          >

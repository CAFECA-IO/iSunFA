      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-20 max-w-5xl">
          <div className="relative grid grid-cols-1 gap-12 lg:grid-cols-3">
            ...
            <div className="dark:border-border-default absolute top-12 left-[16%] hidden w-[68%] border-t-2 border-dashed border-slate-700/60 lg:block">
            ...
            <div className="group relative z-10 flex flex-col items-center text-center">
              <div className="dark:ring-border-default mb-6 flex h-24 w-24 items-center justify-center rounded-3xl bg-slate-800/40 ring-1 ring-slate-700/50 backdrop-blur-md transition-all duration-300 group-hover:-translate-y-2 group-hover:bg-slate-800/60 group-hover:shadow-[0_0_30px_rgba(249,115,22,0.2)] group-hover:ring-orange-500/50">
                <ReceiptText className="h-10 w-10 text-orange-400 transition-transform duration-300 group-hover:scale-110" />
              </div>
              <div className="dark:ring-border-default mb-3 flex items-center justify-center rounded-full bg-slate-800/80 px-3 py-1 text-xs font-bold text-slate-300 ring-1 ring-slate-700/60">
            ...
            <div className="group relative z-10 flex flex-col items-center text-center">
              <div className="dark:ring-border-default mb-6 flex h-24 w-24 items-center justify-center rounded-3xl bg-slate-800/40 ring-1 ring-slate-700/50 backdrop-blur-md transition-all duration-300 group-hover:-translate-y-2 group-hover:bg-slate-800/60 group-hover:shadow-[0_0_30px_rgba(34,197,94,0.2)] group-hover:ring-green-500/50">
            ...
            <div className="group relative z-10 flex flex-col items-center text-center">
              <div className="dark:ring-border-default mb-6 flex h-24 w-24 items-center justify-center rounded-3xl bg-slate-800/40 ring-1 ring-slate-700/50 backdrop-blur-md transition-all duration-300 group-hover:-translate-y-2 group-hover:bg-slate-800/60 group-hover:shadow-[0_0_30px_rgba(59,130,246,0.2)] group-hover:ring-blue-500/50">

 ...
 *
 * 不顯示事由：那是密文入庫的 Tier 2 個資（病名、家屬狀況、司法事由），
 * 而清單是會被投影在會議室螢幕上的畫面。清單只回答「誰、什麼假、幾天、
 * 卡在哪一關」，那足以決定要不要點進去。
 *
 * 顯示「第幾關 / 共幾關」：「等主管簽」與「等三關裡的第二關」對申請人是
 * 完全不同的資訊 —— 後者答得出「還要多久」。
 */
      ...
      {requests.map((item) => (
        ...
        >
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            {/**
             * Info: (20260817 - Julian) 事由只在明細頁看得到（會留個資軌跡），因此清單必須
             * 有一個明確的入口 —— 而不是讓整列可點：那會讓「撤回」按鈕變成踩雷區。
             */}
            <button
              type="button"

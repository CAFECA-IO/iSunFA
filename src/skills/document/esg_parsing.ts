  ...
  async execute(
    ...
    try {
      const responseSchema: Schema = {
        ...
        properties: {
          scope: { type: SchemaType.STRING, description: "範疇，如 SCOPE_1, SCOPE_2, SCOPE_3" },
          ...
          confidence: { type: SchemaType.NUMBER, description: "信心指數 1-100" },
        },
        required: ["scope", "activityType", "vendor", "amount", "unit", "emissions", "confidence"],
      };

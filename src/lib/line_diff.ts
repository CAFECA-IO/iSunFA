// Info: (20260717 - Emily) 行級 diff(#55 修訂對照卡優化):純函式 LCS,無第三方依賴
// Info: (20260717 - Emily) 用途:原文/修訂稿的逐行對照(same/removed/added),讓人工確認一眼看見「動了哪幾行」
...
// Info: (20260717 - Emily) O(n×m) DP 的行數護欄:段落內文通常數十行,超限時由呼叫端退回並列顯示
export const LINE_DIFF_MAX_LINES = 500;

/**
 * Info: (20260717 - Emily) 標準 LCS 行 diff:
...
export const diffLines = (
  ...
  // Info: (20260717 - Emily) LCS 長度表(DP)
  ...
  // Info: (20260717 - Emily) 回溯輸出:相同行 SAME;差異處先 REMOVED(原文)後 ADDED(修訂)

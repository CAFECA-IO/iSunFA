import { z } from 'zod';
import { accountEntityValidator, IAccountValidator } from '@/lib/utils/zod_schema/account';
...
const lineItemGetByAccountBodyValidatorV2 = z.object({});

const lineItemGetByAccountFrontendValidatorV2 = paginatedDataSchema(IReverseItemValidator);

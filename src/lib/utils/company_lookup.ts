...
const COMMON_ABBREVIATIONS: Record<string, ICompanyData> = {
  台積電: { taxId: "2330", name: "台灣積體電路製造股份有限公司" },
  ...
  華碩: { taxId: "2357", name: "華碩電腦股份有限公司" },
  宏碁: { taxId: "2353", name: "宏碁股份有限公司" },
  微星: { taxId: "2377", name: "微星科技股份有限公司" },
  技嘉: { taxId: "2376", name: "技嘉科技股份有限公司" },
  群創: { taxId: "3481", name: "群創光電股份有限公司" },
  友達: { taxId: "2409", name: "友達光電股份有限公司" },
  緯創: { taxId: "3231", name: "緯創資通股份有限公司" },
  台泥: { taxId: "1101", name: "台灣水泥股份有限公司" },
  亞泥: { taxId: "1102", name: "亞洲水泥股份有限公司" },
  中鋼: { taxId: "2002", name: "中國鋼鐵股份有限公司" },
  統一: { taxId: "1216", name: "統一企業股份有限公司" },
  富邦金: { taxId: "2881", name: "富邦金融控股股份有限公司" },
  國泰金: { taxId: "2882", name: "國泰金融控股股份有限公司" },
  兆豐金: { taxId: "2886", name: "兆豐金融控股股份有限公司" },
  中信金: { taxId: "2891", name: "中國信託金融控股股份有限公司" },
  玉山金: { taxId: "2884", name: "玉山金融控股股份有限公司" },
  長榮: { taxId: "2603", name: "長榮海運股份有限公司" },
  陽明: { taxId: "2609", name: "陽明海運股份有限公司" },
  萬海: { taxId: "2615", name: "萬海航運股份有限公司" },
  中華電: { taxId: "2412", name: "中華電信股份有限公司" },
  台灣大: { taxId: "3045", name: "台灣大哥大股份有限公司" },
  遠傳: { taxId: "4904", name: "遠傳電信股份有限公司" },
};
...
export async function lookupCompany(query: string): Promise<ICompanyData[]> {
  ...
  // Info: (20260320 - Tzuhan) 2. Check exact abbreviation or generic substring match

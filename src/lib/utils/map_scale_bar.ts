...
/**
 * Info: (20260801 - Luphia) 超過 50% 即不畫:此時線段在圖的一端與另一端相差逾半,
 * 標註單一參考緯度也救不了想在別處量測的讀者。
 *
 * 實測台北→曼徹斯特的航段兩端比例相差 52%(25.07°N 為 1.104、53.35°N 為 1.675),
 * 正好落在此界之外;東京→巴黎的實際視野含高緯航路,比值更達 3.9。
 */

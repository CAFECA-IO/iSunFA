...
//         lte: endDateInSecond,
//       },
//       invoiceVoucherJournals: { every: { voucher: { type: eventType } } },
//       AND: [
...
//                 every: { vendorOrSupplier: { contains: searchQuery, mode: 'insensitive' } },
//               },
//             },
//             {
//               invoiceVoucherJournals: {
//                 every: { description: { contains: searchQuery, mode: 'insensitive' } },
//               },
//             },
//             {
//               invoiceVoucherJournals: {
//                 every: { voucher: { no: { contains: searchQuery, mode: 'insensitive' } } },
//               },
//             },
//           ],
//         },
...
//       await createInvoice(formattedInvoice, journalIdBeCreated, ocrIdInDB?.imageFileId);

//       createInvoiceVoucherJournal(journalIdBeCreated, formattedInvoice.journalId || 0);
...
//     voucher: { include: { lineItems: { include: { account: true } } } },
//   };
//   const journalList = await prisma.invoiceVoucherJournal.findMany({ where, include });
//   return journalList;
// }

        ...
        case ReportSheetType.BALANCE_SHEET:
            switch (type) {
                case AccountType.ASSET:
                    return new AssetAccountRetriever(companyId, includeDefaultAccount, liquidity, type, reportType, equityType, forUser, page, limit, sortBy, sortOrder, searchKey);
                case AccountType.LIABILITY:
                    return new LiabilityAccountRetriever(companyId, includeDefaultAccount, liquidity, type, reportType, equityType, forUser, page, limit, sortBy, sortOrder, searchKey);
                case AccountType.EQUITY:
                    return new EquityAccountRetriever(companyId, includeDefaultAccount, liquidity, type, reportType, equityType, forUser, page, limit, sortBy, sortOrder, searchKey);
                default:
                    return new BalanceSheetAccountRetriever(companyId, includeDefaultAccount, liquidity, type, reportType, equityType, forUser, page, limit, sortBy, sortOrder, searchKey);
            }
        case ReportSheetType.INCOME_STATEMENT:
            return new IncomeStatementAccountRetriever(companyId, includeDefaultAccount, liquidity, type, reportType, equityType, forUser, page, limit, sortBy, sortOrder, searchKey);
        default:
            return new GeneralAccountRetriever(companyId, includeDefaultAccount, liquidity, type, reportType, equityType, forUser, page, limit, sortBy, sortOrder, searchKey);
    }
}
}

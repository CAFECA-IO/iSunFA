...
export class SemanticAccountMatcher {
  ...
  > = {
    TW: {
      ...
      TELECOM_EXPENSE: "6215", // 郵電費
      SHIPPING_EXPENSE: "6114", // 運費
      ADVERTISING_EXPENSE: "6117", // 廣告費
      SOFTWARE_SUBSCRIPTION: "6225", // 各項攤提
      MEAL_EXPENSE: "6227", // 伙食費
      OFFICE_SUPPLIES: "6212", // 文具用品
      RENT_EXPENSE: "6211", // 租金支出
      TRANSPORTATION_EXPENSE: "6213", // 旅費(交通)
    ...
    US: {
      ...
      ADVERTISING_EXPENSE: "6117",
      SOFTWARE_SUBSCRIPTION: "6225",
      MEAL_EXPENSE: "6227",
      OFFICE_SUPPLIES: "6212",
      RENT_EXPENSE: "6211",
      TRANSPORTATION_EXPENSE: "6213",
      MISCELLANEOUS_EXPENSE: "6288",
      UTILITIES_EXPENSE: "6218",
    },
    JP: {

export const en = {
  ...
  analysis: {
    ...
    insufficient_credits: {
      ...
      message: "You do not have enough credits to perform this analysis. Would you like to purchase more?",
      buy_btn: "Buy Credits",
    },
    time_units: {
      yearly: 'Yearly',
    ...
    confirm_desc: 'This action will consume credits. Please confirm the details below:',
  ...
  calculator: {
    ...
    'base_pay_form':{
      ...
      'additional_information': 'Travel, injury, funeral, retirement pay, social insurance benefits, or government grants'
    },
    'work_hours_form':{
    ...
    'result':{
      ...
      'withheld_second_generation_nhi_premium': 'Withheld Second Generation NHI Premium',
      ...
      'company_burden_occupational_accident_insurance': 'Employer Paid Occupational Accident Insurance',
    ...
    "reset_modal":{
      ...
      "content":"Are you sure you want to reset the calculator? This will clear all entered data.",
    ...
    "message":{
      ...
      "remove_employee_content":"Are you sure you want to remove {{name}} from the employee list?",
      ...
      "re_send_pay_slip_success_content":"The pay slip has been successfully sent to the employee's email.",
    },
    "operating_mechanism":{

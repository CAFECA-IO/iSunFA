export const en = {
  ...
  esg_report: {
    ...
    scopes_title: "EMISSIONS DISTRIBUTION (SCOPES)",
  ...
  report_view: {
    title: "Accounting Reports Center",
    desc: "Automatically aggregates vouchers into financial reports with external embed capabilities.",
    tab_report: "Generate Report",
    tab_embed: "Embed Codes",

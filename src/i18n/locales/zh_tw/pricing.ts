export const pricing = {
  ...
  faith_agent_free_tooltip:
    "免費版的費思為單次問答，不保留個人化記憶。團隊版與企業版的每位成員各自擁有獨立的費思代理人，會逐漸記住您的需求。",
  faith_agent_memory: "費思人工智能代理人（專屬記憶）",
  faith_agent_memory_tooltip:
    "每位成員各自擁有獨立的費思代理人，會記住您的回饋與偏好，越用越貼近您的工作方式。停止訂閱 {{days}} 天後，我們會刪除費思對您的記憶以保障隱私。",
  faith_memory_note_title: "關於費思的專屬記憶",
  faith_memory_note:
    "雲端版的團隊版與企業版，每位成員各自擁有一個獨立的費思人工智能代理人。費思會記錄您在對話中給予的回饋與偏好（例如慣用的會計科目、報表呈現方式、回答的詳細程度），隨著使用逐漸記住您的需求，讓回答越來越貼近您的工作方式；這些記憶只用於改善您個人的使用體驗，不會與其他成員或其他客戶共用，也不會用於訓練共享的 AI 模型。",

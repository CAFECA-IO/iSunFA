export const calculator = {
  ...
  company_setting: {
    main_title: "公司設定",
    section_identity: "公司資訊",
    section_leave_year: "特別休假年度",
    entity_name: "公司名稱",
    entity_name_hint: "事業單位名稱，會印在薪資單與工資清冊上。",
    entity_name_placeholder: "請輸入事業單位全名",
    tax_id: "統一編號",
    responsible_person: "負責人",
    address: "公司地址",
    leave_year_hint:
      "決定特休年度從哪一天結算，由勞雇雙方協商（勞基法施行細則 §24）",
    leave_year_unset: "尚未選擇",
    leave_year_unset_hint: "選定之前，系統不會發出特休年度通知",
    scheme_anniversary: "週年制",
    scheme_anniversary_hint: "自每位勞工受僱當日起算，每滿一年",
    scheme_calendar: "曆年制",
    scheme_calendar_hint: "每年 1 月 1 日至 12 月 31 日",
    scheme_custom: "約定年度",
    scheme_custom_hint: "學年度、會計年度或勞雇雙方另行約定",
    custom_start: "年度起始日",
    month_unit: "月",
    day_unit: "日",
    save: "儲存",
  ...
  employee_list: {
    ...
    leave_end_date: "復職日",
    leave_hint:
      "留職停薪：完整落在這段區間裡的月份不會被算成缺薪資單。起日填留停第一天、復職日填回來上班的第一天 —— 這兩個月仍會計入，因為那個月有上班日。尚未復職就留白。",
    leave_order_error: "復職日不得早於留職停薪起日",
    leave_start_required: "請一併填寫留職停薪起日",
    main_title: "員工列表",
    name: "員工姓名",
    number: "員工編號",
    email: "電子郵件",
  ...
  save_record: {
    ...
    unlinked_conflict_content:
      "員工編號 {{number}} 已經是「{{existingName}}」的。無法用這個編號建立新員工。",
    edit_number: "修改員工編號",
    edit_number_hint: "如果「{{name}}」的編號是別的，回到步驟 1 修改",
    fill_number: "填寫員工編號",
    fill_number_hint: "員工編號是必填的。回到步驟 1 補上。",
  },
  ...
  button: {
    ...
    send_disabled_unlinked: "這張試算已解除員工連結，請重新選擇員工",
    send_disabled_no_email: "這位員工的資料裡沒有電子郵件，請先到員工列表補上",
    send_disabled_employee_gone: "這位員工已從名單移除，無法寄出薪資單",

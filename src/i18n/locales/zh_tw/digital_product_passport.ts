export const digitalProductPassport = {
  ...
  start: {
    ...
    step8: "8. LCA 碳排與環境足跡演算 (generate_lca_ground_truth)",
    step9: "9. 產品合規宣告與驗證數據生成 (generate_compliance_declaration)",
  ...
  simulator: {
    ...
    group_dpp_core: "📊 LCA 碳排足跡與合規 (LCA Footprint & Compliance)",
  ...
  public_passport: {
    not_found_title: "護照未找到",
    not_found_desc:
      "我們無法擷取此產品批次的數位產品護照。它可能尚未建立，或者連結可能不正確。",
    go_to_dashboard: "前往儀表板",
    public_passport_tag: "公開護照",
    download_pdf: "下載 PDF",
    passport_id: "護照 ID",
    verified_by: "通過 TÜV Rheinland 驗證",
    general_info: "基本資訊",
    product_name: "產品名稱",
    model_number: "型號",
    gtin: "GTIN",
    ...
    weight: "重量",
    facility: "設施",
    manufactured_date: "製造日期",
    product_design_blueprint: "產品設計圖",
    batch_details: "批次詳情",
    batch_number: "批次編號",
    serial_range: "序號範圍",
    carbon_footprint: "碳足跡摘要",
    methodology: "計算方法：",
    cradle_to_gate: "搖籃到大門 (Cradle-to-Gate)",
    precursors: "前驅物",
    scope1: "範疇一",
    scope2: "範疇二",
    precursors_emissions: "前驅物排放",
    direct_emissions: "直接排放 (範疇一)",
    indirect_emissions: "間接排放 (範疇二)",
    circularity_composition: "循環性與材料組成",
    recycled_content: "再生材料佔比",
    no_recycled_data: "尚無再生材料資料。",
    recycled_label: "再生比例：",
    pre_consumer: "消費前",
    post_consumer: "消費後",
    primary: "原生材料",
    chemical_composition: "化學組成",
    no_composition_data: "尚無化學組成資料。",
    critical_raw_materials: "關鍵原材料",
    durability_repairability: "耐用性與可維修性",
    physical_lifespan: "物理壽命",
    years: "年",
    repair_instructions: "維修說明",
    no_repair_instructions: "無特殊維修說明。",
    end_of_life: "壽命結束 / 處置",
    disposal_desc: "請按照當地電子廢棄物法規進行處置。",
    compliance_certs: "合規與認證",
    rohs_compliant: "RoHS 合規",
    pfas_free_label: "無 PFAS",
    social_responsibility: "社會責任",
    ethical_sourcing: "倫理採購",
    labor_standards: "勞工標準",
    verified: "已驗證",
    not_audited: "未稽核",
    compliant: "合規",
    not_certified: "未認證",
    ...
    importer_logistics: "歐盟進口商與物流",
    importer_company: "進口商公司",
    eori_number: "EORI 編號",
    importer_address: "進口商地址",
    cradle: "搖籃",
    to_gate: "到大門",
    pre_consumer_val: "消費前 ({{val}}%)",
    post_consumer_val: "消費後 ({{val}}%)",
    primary_val: "原生材料 ({{val}}%)",
    footer_disclaimer:
      "* 碳足跡依據 ISO 14067 / CBAM 執行條例 (EU) 2023/1773 進行評估。系統邊界：搖籃到大門。",
    footer_cn_code: "* 受海關稅則 (CN) 代碼限制：",
    footer_powered_by:
      "由 iSunFA 企業碳會計系統提供支援 • 經去中心化信任引擎驗證",

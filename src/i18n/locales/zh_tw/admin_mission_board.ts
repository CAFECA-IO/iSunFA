export const adminMissionBoard = {
  ...
  pdf_editor: {
    ...
    toast_draft_saved: "草稿已手動儲存",
    toast_report_inserted: "報告生成並插入成功！",
    toast_share_link_failed: "生成分享連結失敗",
    toast_toc_pages_missing: "報告已下載，但目錄頁碼未能填入",
    toast_charts_missing: "報告已下載，但部分圖表未能繪製",
    ...
    report_identity: {
      ...
      verified_by: "查證單位",
      issued_on: "更新日期",
      framework_label: "揭露框架",
      framework_inventory_only: "只出盤查報告書",
      framework_ifrs: "包成 {{name}} 架構",
      framework_hint:
        "選了之後,草稿會依 {{name}} 的架構撰寫。那是關於文件結構的陳述,不是企業層級的合規宣告 —— 後者無論適用時程都不得出現在報告上",
      unfilled: "未填寫",

export const dppUrbanMining = {
  ...
  dpp: {
    ...
    feature1_title: "ESPR 國際合規",
    feature1_desc:
      "完整涵蓋材料成分、環境足跡、耐用性與拆解指南，直面歐盟合規要求。",
    feature2_title: "區塊鏈鏈上存證",
    feature2_desc:
      "產品關鍵數據以不可篡改的雜湊值存證於區塊鏈，為企業與消費者提供極致的信任背書。",
    feature3_title: "一物一碼數位標籤",
    feature3_desc:
  ...
  urban: {
    ...
    feature1_desc:
      "透過 DPP 申報的 BOM 表，自動計算廢棄電子產品中的金、銅、鋰、鈷等高價值金屬儲量。",
    feature2_title: "AI 安全拆解指引",
    feature2_desc:
  ...
  interactive: {
    ...
    material_cobalt: "鈷金屬 (Co)",
    disassembly_safety: "AI 拆解安全警示",
    safety_warning:
      "本電池含有易燃電解液，請依安全手冊在惰性氣體或低溫防護下進行拆解。無毒回收，金屬回收率預計達 96.5%。",
    scanning: "掃描中...",
    rescan: "重新掃描產品護照",
    scan_dpp: "掃描 DPP 二維碼",

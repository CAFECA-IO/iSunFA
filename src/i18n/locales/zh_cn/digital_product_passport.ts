export const digitalProductPassport = {
  ...
  list: {
    ...
    login_to_use: "请登录以使用 DPP 模拟数据生成器",
    create_simulation: "新增模拟企业",
    enter_data_center: "进入数据中心",
    no_simulations: "找不到模拟企业。请点击“新增模拟企业”建立您的第一笔数据。",
    simulator_no_simulations_desc:
      "您可以透过搜寻上市柜公司，自动生成具有真实感的数字产品护照 (DPP) 模拟数据。",
    year_unit: "年",
    demo_data_base: "2025 (展示数据基底)",
    last_year: "2024 (去年度)",
    previous_year: "2023 (前年度)",
    delete_confirm_title: "确认删除",
    delete_confirm_message:
      "确定要删除“{{name}} ({{year}} 年)”的模拟资料吗？此动作无法复原。",
  ...
  public_passport: {
    not_found_title: "护照未找到",
    not_found_desc:
      "我们无法提取此产品批次的数字产品护照。它可能尚未创建，或者链接可能不正确。",
    go_to_dashboard: "前往仪表板",
    public_passport_tag: "公开护照",
    download_pdf: "下载 PDF",
    passport_id: "护照 ID",
    verified_by: "通过 TÜV Rheinland 验证",
    general_info: "基本信息",
    product_name: "产品名称",
    model_number: "型号",
    gtin: "GTIN",
    ...
    weight: "重量",
    facility: "设施",
    manufactured_date: "制造日期",
    product_design_blueprint: "产品设计图",
    batch_details: "批次详情",
    batch_number: "批次编号",
    serial_range: "序号范围",
    carbon_footprint: "碳足迹摘要",
    methodology: "计算方法：",
    cradle_to_gate: "摇篮到大门 (Cradle-to-Gate)",
    precursors: "前驱体",
    scope1: "范围一",
    scope2: "范围二",
    precursors_emissions: "前驱体排放",
    direct_emissions: "直接排放 (范围一)",
    indirect_emissions: "间接排放 (范围二)",
    circularity_composition: "循环性与材料组成",
    recycled_content: "再生材料占比",
    no_recycled_data: "尚无再生材料资料。",
    recycled_label: "再生比例：",
    pre_consumer: "消费前",
    post_consumer: "消费后",
    primary: "原生材料",
    chemical_composition: "化学组成",
    no_composition_data: "尚无化学组成资料。",
    critical_raw_materials: "关键原材料",
    durability_repairability: "耐用性与可维修性",
    physical_lifespan: "物理寿命",
    years: "年",
    repair_instructions: "维修说明",
    no_repair_instructions: "无特殊维修说明。",
    end_of_life: "寿命结束 / 处置",
    disposal_desc: "请按照当地电子废弃物法规进行处置。",
    compliance_certs: "合规与认证",
    rohs_compliant: "RoHS 合规",
    pfas_free_label: "无 PFAS",
    social_responsibility: "社会责任",
    ethical_sourcing: "伦理采购",
    labor_standards: "劳工标准",
    verified: "已验证",
    not_audited: "未稽查",
    compliant: "合规",
    not_certified: "未认证",
    non_compliant: "不合规",
    contains_pfas: "含有 PFAS",
    pfas_free: "无 PFAS",
    attached_declaration: "附加宣告文件",
    importer_logistics: "欧盟进口商与物流",
    importer_company: "进口商公司",
    eori_number: "EORI 编号",
    importer_address: "进口商地址",
    cradle: "摇篮",
    to_gate: "到大门",
    pre_consumer_val: "消费前 ({{val}}%)",
    post_consumer_val: "消费后 ({{val}}%)",
    primary_val: "原生材料 ({{val}}%)",
    footer_disclaimer:
      "* 碳足迹依据 ISO 14067 / CBAM 执行条例 (EU) 2023/1773 进行评估。系统边界：摇篮到大门。",
    footer_cn_code: "* 受海关税则 (CN) 代码限制：",
    footer_powered_by:
      "由 iSunFA 企业碳会计系统提供支持 • 经去中心化信任引擎验证",

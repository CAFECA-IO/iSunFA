export const calculator = {
  ...
  company_setting: {
    main_title: "公司设置",
    section_identity: "公司信息",
    section_leave_year: "年休假年度",
    entity_name: "公司名称",
    entity_name_hint: "单位名称，会印在工资单与工资清册上。",
    entity_name_placeholder: "请输入单位全名",
    tax_id: "统一编号",
    responsible_person: "负责人",
    address: "公司地址",
    leave_year_hint: "决定年休假年度何时结算，由劳资双方协商",
    leave_year_unset: "尚未选择",
    leave_year_unset_hint: "选定之前，系统不会发出年休假年度通知",
    scheme_anniversary: "周年制",
    scheme_anniversary_hint: "自每位劳工受雇当日起算，每满一年",
    scheme_calendar: "历年制",
    scheme_calendar_hint: "每年 1 月 1 日至 12 月 31 日",
    scheme_custom: "约定年度",
    scheme_custom_hint: "学年度、会计年度或劳资双方另行约定",
    custom_start: "年度起始日",
    month_unit: "月",
    day_unit: "日",
    save: "保存",

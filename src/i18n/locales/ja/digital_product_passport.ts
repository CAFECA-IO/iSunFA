export const digitalProductPassport = {
  ...
  list: {
    ...
    login_to_use:
      "DPPシミュレーターデータジェネレーターを使用するにはログインしてください",
    ...
    simulator_no_simulations_desc:
      "上場企業を検索することで、リアリティのあるデジタル製品パスポート（DPP）の模擬データを自動生成できます。",
    year_unit: "年",
    demo_data_base: "2025 (デモデータ基盤)",
    last_year: "2024 (昨年度)",
    ...
    simulation_progress: "シミュレーションの進捗",
    has_data: "データあり",
    no_data: "データなし",
    phase1: "フェーズ1: 基礎データ",
  ...
  public_passport: {
    not_found_title: "パスポートが見つかりません",
    not_found_desc:
      "この製品バッチのデジタル製品パスポートを取得できませんでした。まだ作成されていないか、リンクが正しくない可能性があります。",
    go_to_dashboard: "ダッシュボードへ",
    public_passport_tag: "公開パスポート",
    download_pdf: "PDFをダウンロード",
    passport_id: "パスポートID",
    verified_by: "TÜV Rheinlandによる検証済み",
    general_info: "基本情報",
    product_name: "製品名",
    model_number: "型番",
    gtin: "GTIN",
    ...
    product_design_blueprint: "製品設計図",
    batch_details: "バッチ詳細",
    batch_number: "バッチ番号",
    serial_range: "シリアル範囲",
    carbon_footprint: "カーボンフットプリント概要",
    methodology: "算定方法：",
    cradle_to_gate: "ISO 14067 (Cradle-to-Gate)",
    precursors: "前駆体",
    scope1: "スコープ1",
    scope2: "スコープ2",
    precursors_emissions: "前駆体排出量",
    direct_emissions: "直接排出量 (スコープ1)",
    indirect_emissions: "間接排出量 (スコープ2)",
    circularity_composition: "循環性と材料構成",
    recycled_content: "再生材料含有率",
    no_recycled_data: "再生材料データはありません。",
    recycled_label: "再生比率：",
    pre_consumer: "ポストインダストリアル",
    post_consumer: "ポストコンシューマー",
    primary: "バージン材料",
    chemical_composition: "化学組成",
    no_composition_data: "化学組成データはありません。",
    critical_raw_materials: "クリティカル原材料",
    durability_repairability: "耐久性と修理可能性",
    physical_lifespan: "物理的寿命",
    years: "年",
    repair_instructions: "修理手順",
    no_repair_instructions: "特別な修理手順はありません。",
    end_of_life: "製品寿命の終了 / 廃棄",
    disposal_desc: "地域の電子廃棄物規制に従って廃棄してください。",
    compliance_certs: "コンプライアンスと認証",
    rohs_compliant: "RoHS適合",
    pfas_free_label: "PFASフリー",
    social_responsibility: "社会的責任",
    ethical_sourcing: "倫理的調達",
    labor_standards: "労働基準",
    verified: "検証済み",
    not_audited: "未監査",
    compliant: "適合",
    not_certified: "未認証",
    non_compliant: "不適合",
    contains_pfas: "PFAS含有",
    pfas_free: "PFASフリー",
    attached_declaration: "添付宣言書類",
    importer_logistics: "EU輸入業者と物流",
    importer_company: "輸入会社",
    eori_number: "EORI番号",
    importer_address: "輸入業者住所",
    cradle: "Cradle",
    to_gate: "to Gate",
    pre_consumer_val: "ポストインダストリアル ({{val}}%)",
    post_consumer_val: "ポストコンシューマー ({{val}}%)",
    primary_val: "バージン材料 ({{val}}%)",
    footer_disclaimer:
      "* カーボンフットプリントは、ISO 14067 / CBAM実施規則 (EU) 2023/1773に従って評価されています。システム境界：Cradle-to-Gate。",
    footer_cn_code: "* 税則 (CN) コードの対象：",
    footer_powered_by:
      "iSunFAエンタープライズ炭素会計システムによる提供 • 分散型信頼エンジンによる検証済み",

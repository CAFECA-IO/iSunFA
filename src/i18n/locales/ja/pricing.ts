export const pricing = {
  ...
  faith_agent_free_tooltip:
    "無料プランの Faith は一問一答で、個人向けの記憶は保持しません。チームプランとビジネスプランでは、メンバーごとに専用の Faith エージェントが用意され、使うほどご要望を覚えていきます。",
  faith_agent_memory: "Faith AI エージェント（専用メモリ）",
  faith_agent_memory_tooltip:
    "メンバーごとに専用の Faith エージェントをご用意します。フィードバックや好みを記憶し、使うほどお客様の進め方に近づきます。サブスクリプション終了から {{days}} 日後、プライバシー保護のため Faith が記憶した内容を削除します。",
  faith_memory_note_title: "Faith の専用メモリについて",
  faith_memory_note:
    "クラウド版のチームプランとビジネスプランでは、メンバーごとに独立した Faith AI エージェントをご用意します。Faith は対話の中でいただいたフィードバックや好み（よく使う勘定科目、帳票の見せ方、回答の詳しさなど）を記録し、使うほどご要望を覚えて、お客様の進め方に沿った回答に近づけていきます。この記憶はお客様ご自身の利用体験の改善にのみ用いられ、他のメンバーや他のお客様と共有されることはなく、共有 AI モデルの学習にも使用しません。",

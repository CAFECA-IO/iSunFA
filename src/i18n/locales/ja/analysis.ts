export const analysis = {
  ...
  addon_bookkeeper: "計理士監査を追加",
  addon_cpa: "公認会計士監査を追加",
  addon_third_party: "第三者検証機関の監査を追加",
  addons_title: "追加オプション（複数選択可）",
  ...
  share_settings: {
    ...
    privacy_warning_desc:
      "外部へ共有する前に、必ず適切な承認を得てください。営業秘密の漏洩を防ぐため、「匿名化して金額を隠す」を選択することを強くお勧めします。",
    hide_data_title: "🛡️ 匿名化して金額を隠す (推奨)",
    hide_data_desc:
      "特定の伝票、仕入先詳細、および絶対金額を非表示にし、AIによって生成された構造的洞察とリスク評価の結論のみを共有します。営業秘密を最大限に保護します。",
    show_data_title: "⚠️ 機密金額を含めて完全に公開",
    show_data_desc:
      "すべての勘定科目、絶対残高、および関連するすべての分析が詳細に公開されます。リンクを知っている人なら誰でも、社内の運用データ全体を閲覧できます。",
    confirm: "確認してリンクを生成",
  },
};

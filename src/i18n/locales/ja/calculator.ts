export const calculator = {
  ...
  company_setting: {
    main_title: "会社設定",
    section_identity: "会社情報",
    section_leave_year: "年次有給休暇年度",
    entity_name: "会社名",
    entity_name_hint:
      "事業所の正式名称。給与明細および賃金台帳に印字されます。",
    entity_name_placeholder: "事業所の正式名称を入力してください",
    tax_id: "統一番号",
    responsible_person: "代表者",
    address: "会社所在地",
    leave_year_hint: "有給休暇年度の締め日を決定します（労使協議による）",
    leave_year_unset: "未選択",
    leave_year_unset_hint: "選択するまで年度通知は送信されません",
    scheme_anniversary: "入社日基準",
    scheme_anniversary_hint: "従業員ごとの入社日から1年ごと",
    scheme_calendar: "暦年基準",
    scheme_calendar_hint: "1月1日から12月31日まで",
    scheme_custom: "協定年度",
    scheme_custom_hint: "学年度、会計年度、その他労使で定めた期間",
    custom_start: "年度開始日",
    month_unit: "月",
    day_unit: "日",
    save: "保存",
  ...
  access: {
    checking: "権限を確認しています…",
    check_failed:
      "この帳簿での権限を確認できませんでした。しばらくしてからお試しください。",
    denied_title: "この帳簿の給与機能はご利用いただけません",
    denied_desc:
      "給与計算機・給与記録・従業員リストは、帳簿のオーナーと編集者のみが利用できます。あなたはこの帳簿では閲覧のみのメンバーのため、このセクションは表示されません。利用が必要な場合はオーナーに権限の変更を依頼してください。",
    denied_public_link: "公開版の給与計算機を使う",
  },
  account_book_entry: {
    title: "この試算を保存しますか？",

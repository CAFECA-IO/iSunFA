export const calculator = {
  ...
  company_setting: {
    main_title: "회사 설정",
    section_identity: "회사 정보",
    section_leave_year: "연차 휴가 연도",
    entity_name: "회사명",
    entity_name_hint:
      "사업체 정식 명칭입니다. 급여명세서와 임금대장에 인쇄됩니다.",
    entity_name_placeholder: "사업체 정식 명칭을 입력하세요",
    tax_id: "사업자등록번호",
    responsible_person: "대표자",
    address: "회사 주소",
    leave_year_hint: "연차 연도 정산 시점을 결정하며 노사 협의로 정합니다",
    leave_year_unset: "선택 안 함",
    leave_year_unset_hint: "선택하기 전까지 연차 연도 통지를 보내지 않습니다",
    scheme_anniversary: "입사일 기준",
    scheme_anniversary_hint: "각 근로자의 입사일부터 매 1년",
    scheme_calendar: "역년 기준",
    scheme_calendar_hint: "매년 1월 1일부터 12월 31일까지",
    scheme_custom: "약정 연도",
    scheme_custom_hint: "학년도, 회계연도 또는 노사가 정한 기간",
    custom_start: "연도 시작일",
    month_unit: "월",
    day_unit: "일",
    save: "저장",

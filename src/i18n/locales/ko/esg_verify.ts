export const esgVerify = {
  ...
  form: {
    ...
    ghg_category: "GHG Protocol 범위",
    iso_category: "ISO 14064-1 범주",
    ghg_category_placeholder: "GHG Protocol 범위를 선택하십시오",
    iso_category_placeholder: "ISO 14064-1 범주를 선택하십시오",
    none: "없음",
    activity_type: "활동 유형",

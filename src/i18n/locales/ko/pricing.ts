export const pricing = {
  ...
  faith_agent_free_tooltip:
    "무료 요금제의 Faith는 단발성 질의응답으로, 개인화된 기억을 보관하지 않습니다. 팀·비즈니스 요금제에서는 구성원마다 전용 Faith 에이전트가 제공되어 사용할수록 필요를 기억합니다.",
  faith_agent_memory: "Faith AI 에이전트(전용 기억)",
  faith_agent_memory_tooltip:
    "구성원마다 전용 Faith 에이전트를 제공합니다. 남기신 피드백과 선호를 기억해 사용할수록 업무 방식에 가까워집니다. 구독 종료 후 {{days}}일이 지나면 개인정보 보호를 위해 Faith가 기억한 내용을 삭제합니다.",
  faith_memory_note_title: "Faith 전용 기억에 대하여",
  faith_memory_note:
    "클라우드 팀·비즈니스 요금제에서는 구성원마다 독립된 Faith AI 에이전트를 제공합니다. Faith는 대화 중 남기신 피드백과 선호(자주 쓰는 계정과목, 보고서 표현 방식, 답변의 상세도 등)를 기록해 사용할수록 필요를 기억하고, 답변을 업무 방식에 맞춰 갑니다. 이 기억은 오직 본인의 사용 경험 개선에만 쓰이며, 다른 구성원이나 다른 고객과 공유되지 않고 공용 AI 모델 학습에도 사용되지 않습니다.",

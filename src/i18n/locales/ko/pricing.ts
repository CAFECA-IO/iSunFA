export const pricing = {
  ...
  solutions: {
    page_title: "지속 가능성 솔루션",
    description: "기업 규모에 가장 적합한 탄소 발자국 서비스를 선택하세요",
    ...
    title: "각종 솔루션",
    subtitle:
      "표준화된 탄소 인벤토리 서비스를 제공하며, 서비스 내용은 모두 동일합니다",
    per_project: "/ project",
    ...
    iso14064: {
      tab: "조직 온실가스 인벤토리",
      title: "조직 온실가스 인벤토리 솔루션 (ISO 14064-1)",

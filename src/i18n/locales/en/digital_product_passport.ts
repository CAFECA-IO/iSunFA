export const digitalProductPassport = {
  ...
  list: {
    ...
    login_to_use: "Please login to use DPP Simulator Data Generator",
    create_simulation: "New Simulation",
    enter_data_center: "Enter Data Center",
    no_simulations:
      "No simulated enterprises found. Click 'New Simulation' to create your first dataset.",
    simulator_no_simulations_desc:
      "You can automatically generate realistic Digital Product Passport (DPP) simulation data by searching for listed companies.",
    year_unit: "",
    demo_data_base: "2025 (Demo Data Base)",
    last_year: "2024 (Last Year)",
    previous_year: "2023 (Previous Year)",
  ...
  public_passport: {
    not_found_title: "Passport Not Found",
    not_found_desc:
      "We couldn't retrieve the Digital Product Passport for this product batch. It may not have been created yet, or the link might be incorrect.",
    go_to_dashboard: "Go to Dashboard",
    public_passport_tag: "Public Passport",
    download_pdf: "Download PDF",
    passport_id: "Passport ID",
    verified_by: "VERIFIED BY TÜV Rheinland",
    ...
    product_design_blueprint: "Product Design Blueprint",
    batch_details: "Batch Details",
    batch_number: "Batch Number",
    serial_range: "Serial Range",
    carbon_footprint: "Carbon Footprint Summary",
    methodology: "Methodology:",
    cradle_to_gate: "ISO 14067 (Cradle-to-Gate)",
    precursors: "Precursors",
    scope1: "Scope 1",
    scope2: "Scope 2",
    precursors_emissions: "Precursors Emissions",
    direct_emissions: "Direct Emissions (Scope 1)",
    indirect_emissions: "Indirect Emissions (Scope 2)",
    circularity_composition: "Circularity & Material Composition",
    recycled_content: "Recycled Content Share",
    no_recycled_data: "No recycled content data available.",
    recycled_label: "Recycled:",
    pre_consumer: "Pre-consumer",
    post_consumer: "Post-consumer",
    primary: "Primary",
    chemical_composition: "Chemical Composition",
    no_composition_data: "No chemical composition data available.",
    critical_raw_materials: "Critical Raw Materials",
    durability_repairability: "Durability & Repairability",
    physical_lifespan: "Physical Lifespan",
    years: "Years",
    repair_instructions: "Repairability Instructions",
    no_repair_instructions: "No special repair instructions.",
    end_of_life: "End of Life / Disposal",
    disposal_desc: "Dispose in accordance with local e-waste regulations.",
    compliance_certs: "Compliance & Certifications",
    rohs_compliant: "RoHS Compliant",
    pfas_free_label: "PFAS Free",
    ...
    contains_pfas: "Contains PFAS",
    pfas_free: "PFAS Free",
    attached_declaration: "Attached Declaration Document",
    importer_logistics: "EU Importer & Logistics",
    importer_company: "Importer Company",
    eori_number: "EORI Number",
    importer_address: "Importer Address",
    cradle: "Cradle",
    to_gate: "to Gate",
    pre_consumer_val: "Pre-consumer ({{val}}%)",
    post_consumer_val: "Post-consumer ({{val}}%)",
    primary_val: "Primary ({{val}}%)",
    footer_disclaimer:
      "* Carbon footprint evaluated according to ISO 14067 / CBAM Implementing Regulation (EU) 2023/1773. System boundary: Cradle-to-Gate.",
    footer_cn_code: "* Subject to Customs Nomenclature (CN) Code:",
    footer_powered_by:
      "Powered by iSunFA Enterprise Carbon Accounting System • Verified via Decentralized Trust Engine",

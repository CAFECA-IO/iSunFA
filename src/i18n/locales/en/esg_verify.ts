export const esgVerify = {
  ...
  form: {
    ...
    ghg_category: "GHG Protocol Scope",
    iso_category: "ISO 14064-1 Category",
    ghg_category_placeholder: "Please select GHG Protocol Scope",
    iso_category_placeholder: "Please select ISO 14064-1 Category",
    none: "None",

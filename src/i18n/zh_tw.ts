export const zhTw = {
  ...
  ocr: {
    ...
    analyze_prompt: "是否分析此發票？",
    analyze_btn: "是的，讓 AI 分析發票",
    reupload_btn: "重新上傳",
    search_placeholder: "搜尋發票內容...",
    sort_desc: "由新到舊排序",
    sort_asc: "由舊到新排序",
    start_date: "開始日期",
    end_date: "結束日期",
    ...
    no_image: "無縮圖",
    no_records: "找不到任何紀錄",
    analyzing: "AI 正在為您分析發票...",
    please_wait: "這可能需要一點時間，請稍候",
    detail_title: "發票詳情",
    edit: "編輯",
    save: "儲存",
    delete: "刪除發票",
    confirm_delete_title: "刪除發票",
    confirm_delete_msg: "確定要刪除這筆發票嗎？此動作無法復原。",
    cancel: "取消",

export const zhTw = {
  ...
  esg_report: {
    ...
    no_records: "該範疇無排放紀錄",
    scopes_title: "排放範疇分布 SCOPES",
    proportion: "% 佔比",
    gross_emissions_bottom: "總排放量 (Gross Emissions)",
    scope1_title: "範疇一 (Scope 1)",
    scope2_title: "範疇二 (Scope 2)",
    scope3_title: "範疇三 (Scope 3)",
  },
  report_view: {
    title: "會計報表中心",
    desc: "自動根據傳票資訊彙整各類財務報表，並提供外部嵌入功能。",
    tab_report: "產出報表",
    tab_embed: "嵌入碼管理",
    report_type: "報表種類",

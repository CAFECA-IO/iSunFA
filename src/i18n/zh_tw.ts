export const zhTw = {
  ...
  features: {
    ...
    description:
      "從自動記帳、薪資管理到即時報表與稅務申報，iSunFA 透過 AI 智能精準優化您的完整財務流程。",
    items: {
      bookkeeping: {
        title: "自動記帳",
        desc: "由會計專業智能助手自動完成會計分錄，帳本品質媲美資深會計師多年實務經驗。",
      },
      adjustment: {
        title: "財務智控",
        desc: "整合預算規劃、簽呈審核到銀行轉帳，提高作業效率。",
      },
      cashier: {
        title: "智能收款",
        desc: "整合虛擬收款帳戶與電子發票流程，消除作業時間差。",
      },
      analysis: {
        title: "財務分析",
      ...
      salary: {
        title: "薪資管理",
        desc: "從精準計薪到電子薪資條雲端保管，讓薪酬管理與發放全面智慧自動化。",
      },
      financial_report: {
        title: "會計報表",
      ...
      ocr: {
        title: "智能憑證辨識",
        desc: "自動辨識單據發票，提取關鍵欄位並自動分類歸檔，擺脫耗時費力的手動輸入作業。",
      },
      integration: {
        title: "異質資料整合",
      ...
      esg: {
        title: "溫室氣體核算",
        desc: "企業活動數據精準換算溫室氣體排放量，讓碳費成本與合規風險即時可視。",
      },
      audit: {
        title: "智能稽核",
        desc: "即時分析帳本並提供精準修正建議，確保會計分錄始終準確、合規無虞。",
      },
    },
  },
  registration_steps: {

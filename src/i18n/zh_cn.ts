export const zhCn = {
  ...
  esg_report: {
    ...
    no_records: "该范畴无排放纪录",
    scopes_title: "排放范畴分布 SCOPES",
    proportion: "% 占比",
    gross_emissions_bottom: "总排放量 (Gross Emissions)",
    scope1_title: "范畴一 (Scope 1)",
    scope2_title: "范畴二 (Scope 2)",
    scope3_title: "范畴三 (Scope 3)",
  },
  report_view: {
    title: "会计报表中心",
    desc: "自动根据传票资讯汇整各类财务报表，并提供外部嵌入功能。",
    tab_report: "产出报表",
    tab_embed: "嵌入码管理",
    report_type: "报表种类",

export const zhCn = {
    ...
    plans: {
      ...
      free: {
        ...
        features: {
          ...
          daily_credits: "每日登录发放 10 点点数",
          consults: "每月最多咨询 60 个问题",
          consults_tooltip: "每个问题 5 点",
          vouchers: "每月最多分析 300 份会计凭证",
          vouchers_overage_tooltip: "每份 1 点数",
          ai_reports: "每月最多 3 份 AI 分析报告",
          ai_overage_tooltip: "每份 500 点数",
        },
      },
      team: {
  ...
  hero: {
    ...
    subtitle_line7: "提供绿色金融解决方案，协助企业实现永续发展目标。",
    pricing_link: "收费模式",
    free_trial: "免费试用",
  },
  footer: {
  ...
  ocr: {
    ...
    page_count: "选择张数",
    page_unit: "张",
    required_points: "所需点数",
    balance_after_payment: "支付后余额",

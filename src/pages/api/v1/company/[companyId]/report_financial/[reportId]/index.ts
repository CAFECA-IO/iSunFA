...
import { formatApiResponse, formatNumberSeparateByComma, getTimestampOfSameDateOfLastYear, isParamNumeric } from '@/lib/utils/common';
...
export function generateIAccountReadyForFrontendArray(curPeriodReport: IReport | null, prePeriodReport: IReport | null): IAccountReadyForFrontend[] {
    const curPeriodAccountReadyForFrontendArray: IAccountReadyForFrontend[] = [];

    if (curPeriodReport && prePeriodReport && curPeriodReport.reportType === prePeriodReport.reportType) {

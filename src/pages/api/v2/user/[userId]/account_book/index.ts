...
import { IAccountBook, IAccountBook, IAccountBookWithTeam } from '@/interfaces/account_book';
...
const handleGetRequest = async (req: NextApiRequest) => {
  ...
  let payload: IPaginatedData<IAccountBook[] | IAccountBookWithTeam[]> | null = null;
  ...
  let options: IPaginatedOptions<IAccountBook[] | IAccountBookWithTeam[]> | null = null;

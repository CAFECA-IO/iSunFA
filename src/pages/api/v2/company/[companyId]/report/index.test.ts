...
const mockCompany: Company = {
  ...
  deletedAt: null,
  // tag: 'all', // Info: (20241120 - Shirley) tag is not on the required type
};
  ...
  describe('report handlers', () => {
    describe('balance sheet handler', () => {
      ...
      it('should calculate correct answer', async () => {
        ...
        console.log('balance sheet', 'details[0]', details[0]);
        ...
        const cashAndCashEquivalents = details.find((detail) => detail.id === 1256);

        console.log('cashAndCashEquivalents', cashAndCashEquivalents);

import handler from '@/pages/api/v2/todo/[todoId]/index';
import { NextApiRequest, NextApiResponse } from 'next';
import prisma from '@/client';
import { UserActionLogActionType } from '@/constants/user_action_log';

import { todoDeleteSchema } from '@/lib/utils/zod_schema/todo';
...
describe('company/[companyId]/voucher integration test', () => {
  ...
  xdescribe('Delete todo', () => {
    it('should return data match frontend validator', async () => {
      ...
      const outputValidator = todoDeleteSchema.frontend;

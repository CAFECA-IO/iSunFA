...
export default function MyComponent() {
  return (
    <section className="font-barlow flex flex-col p-12 mt-20 max-w-full shadow-xl bg-secondaryBlue rounded-xl w-800px max-md:px-5 max-md:mt-10">
      <div className="text-5xl font-semibold tracking-tighter text-amber-400 leading-51.92px max-md:max-w-full">
        Get In Touch
      </div>
      ...
      <div className="justify-center items-start px-4 py-2.5 text-xl tracking-tight leading-7 whitespace-nowrap rounded border border-solid bg-slate-600 border-sky-950 text-slate-400 max-md:pr-5 max-md:max-w-full">
        example
      </div>
      ...
      <div className="justify-center items-start px-4 py-2.5 mt-2 text-xl tracking-tight leading-7 whitespace-nowrap rounded border border-solid bg-slate-600 border-sky-950 text-slate-400 max-md:pr-5 max-md:max-w-full">
        example
      </div>
      ...
      <div className="justify-center px-3.5 py-2 text-xl tracking-tight leading-7 rounded border border-solid bg-slate-600 border-sky-950 text-slate-400 max-md:max-w-full">
        Autosize height based on content lines
        <br />
        <br />
      </div>
      <div className="flex gap-2 justify-center self-end px-6 py-2.5 mt-8 font-semibold tracking-normal whitespace-nowrap bg-amber-400 rounded-md text-blue-950 max-md:px-5">
        <div>Submit</div>
        <img
          loading="lazy"

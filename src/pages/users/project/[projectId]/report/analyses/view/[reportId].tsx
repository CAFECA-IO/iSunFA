...
interface IProjectAnalysesReportDetailPageProps {
  projectId: string;
  reportId: string;
}

const ProjectAnalysesReportDetailPage = ({
  projectId,
  reportId,
}: IProjectAnalysesReportDetailPageProps) => {
  return (
    <>
      <Head>
        <meta charSet="UTF-8" />
...
export default ProjectAnalysesReportDetailPage;

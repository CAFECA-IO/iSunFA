...
export enum APIPath {
  ...
  VOUCHER_GET_PREVIEW_CREATING_PROCESS_STATE_BY_RESULT_ID = `${apiPrefix}/company/:companyId/voucher/:voucherId/process_statue`,
  ...
  UPLOAD_JOURNAL = `${apiPrefix}//api/v1/company/:companyId/journal`,

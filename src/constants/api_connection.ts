...
export enum APIPath {
  ...
  LIST_CERTIFICATE_RC2_INPUT = `${apiPrefix}/company/:companyId/certificate/input`,
  CREATE_CERTIFICATE_RC2_INPUT = `${apiPrefix}/company/:companyId/certificate/input`,
  GET_CERTIFICATE_RC2_INPUT = `${apiPrefix}/company/:companyId/certificate/input/:certificateId`,
  DELETE_CERTIFICATE_RC2_INPUT = `${apiPrefix}/company/:companyId/certificate/input/:certificateId`,
  INPUT_INVOICE_CREATE = `${apiPrefix}/company/:companyId/certificate/input/:certificateId/invoice`,
  UPDATE_CERTIFICATE_RC2_INPUT = `${apiPrefix}/company/:companyId/certificate/input/:certificateId/invoice/:invoiceId`,
  CREATE_CERTIFICATE_RC2_OUTPUT = `${apiPrefix}/company/:companyId/certificate/output`,
  GET_CERTIFICATE_RC2_OUTPUT = `${apiPrefix}/company/:companyId/certificate/output/:certificateId`,
  DELETE_CERTIFICATE_RC2_OUTPUT = `${apiPrefix}/company/:companyId/certificate/output/:certificateId`,
  OUTPUT_INVOICE_CREATE = `${apiPrefix}/company/:companyId/certificate/output/:certificateId/invoice`,
  UPDATE_CERTIFICATE_RC2_OUTPUT = `${apiPrefix}/company/:companyId/certificate/output/:certificateId/invoice/:invoiceId`,
  LIST_CERTIFICATE_RC2_OUTPUT = `${apiPrefix}/company/:companyId/certificate/output`,

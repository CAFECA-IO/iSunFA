...
export enum APIPath {
  ...
  GET_CERTIFICATE_RC2_INPUT = `${apiPrefix}/account_book/:accountBookId/certificate/input/:certificateId`,
  DELETE_CERTIFICATE_RC2_INPUT = `${apiPrefix}/account_book/:accountBookId/certificate/input/:certificateId`,
  INPUT_INVOICE_CREATE = `${apiPrefix}/account_book/:accountBookId/certificate/input/:certificateId/invoice`,
  UPDATE_CERTIFICATE_RC2_INPUT = `${apiPrefix}/account_book/:accountBookId/certificate/input/:certificateId/invoice/:invoiceId`,
  CREATE_CERTIFICATE_RC2_OUTPUT = `${apiPrefix}/account_book/:accountBookId/certificate/output`,
  GET_CERTIFICATE_RC2_OUTPUT = `${apiPrefix}/account_book/:accountBookId/certificate/output/:certificateId`,
  DELETE_CERTIFICATE_RC2_OUTPUT = `${apiPrefix}/account_book/:accountBookId/certificate/output/:certificateId`,
  OUTPUT_INVOICE_CREATE = `${apiPrefix}/account_book/:accountBookId/certificate/output/:certificateId/invoice`,
  UPDATE_CERTIFICATE_RC2_OUTPUT = `${apiPrefix}/account_book/:accountBookId/certificate/output/:certificateId/invoice/:invoiceId`,

...
enum ErrorCode {
  ...
  USER_NOT_IN_TEAM = '409ISF0007', // Todo: (20250307 - Tzuhan) 要確認 error code 是否正確，我記得有一個文檔有記錄，暫時沒有找到，找到後修改
  ONLY_EDITOR_AND_VIEWER_CAN_LEAVE = '409ISF0008',
}
...
enum ErrorMessage {
  ...
  ONLY_EDITOR_AND_VIEWER_CAN_LEAVE = 'Only editor and viewer can leave',
}
...
export const STATUS_CODE = {
  ...
  [STATUS_MESSAGE.ONLY_EDITOR_AND_VIEWER_CAN_LEAVE]: ErrorCode.ONLY_EDITOR_AND_VIEWER_CAN_LEAVE,
};

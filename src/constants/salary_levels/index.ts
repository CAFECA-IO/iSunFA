...
export type SalaryLevel = (typeof SALARY_LEVELS_2025.data)[number];
export type SalaryDeduction = (typeof SALARY_DEDUCTION_2025.DATA)[number];
export type OccupationalAccidentInsuranceRate =
...
export const SALARY_LEVELS = [SALARY_LEVELS_2025, SALARY_LEVELS_2026];
export const SALARY_DEDUCTIONS = [SALARY_DEDUCTION_2025, SALARY_DEDUCTION_2026];
export const OCCUPATIONAL_ACCIDENT_INSURANCE_RATE = [
  OCCUPATIONAL_ACCIDENT_INSURANCE_RATE_2025,
  OCCUPATIONAL_ACCIDENT_INSURANCE_RATE_2026,
];
export const INSURANCE_PARAMETERS = [INSURANCE_PARAMETERS_2025, INSURANCE_PARAMETERS_2026];

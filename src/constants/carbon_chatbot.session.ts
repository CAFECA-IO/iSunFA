// Info: (20260714 - Emily) Carbon Chatbot session 工廠(取代 carbon_chatbot.mock 的假資料)
// Info: (20260714 - Emily) 段落一律從空白骨架展開;內容僅能由 AI 對話/附件管線生成或自 localStorage 草稿還原
...
// Info: (20260714 - Emily) 預設 session 標題(初次進入的年度盤查)
...
// Info: (20260714 - Emily) 建立全新 session:空對話 + 空白 33 段報告骨架

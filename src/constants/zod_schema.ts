...
export const ZOD_SCHEMA_API = {
  ...
  [APIName.VOUCHER_POST_V2]: voucherRequestValidatorsV2.create,
  [APIName.VOUCHER_LIST_V2]: voucherRequestValidatorsV2.list,
  [APIName.VOUCHER_GET_BY_ID_V2]: voucherRequestValidatorsV2.getById,
  [APIName.VOUCHER_PUT_V2]: voucherRequestValidatorsV2.update,
  [APIName.VOUCHER_DELETE_V2]: voucherRequestValidatorsV2.delete,
  [APIName.VOUCHER_RESTORE_V2]: voucherRequestValidatorsV2.restore,
  [APIName.VOUCHER_LIST_GET_BY_ACCOUNT_V2]: voucherRequestValidatorsV2.listByAccount,

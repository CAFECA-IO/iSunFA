...
3. **資料量化要求**：重點展示具體「財務數據與關鍵分數」，避免空泛形容詞。⚠️【防幻覺警告】：嚴禁自行捏造任何財務數字，若原始資料未提及具體金額，請直接填寫 N/A。
4. **🔥 最高優先級防幻覺 (Zero-Data Handle)**：如果沒有看到數據，請承認沒有，嚴禁為了填寫模板（如 Key Strengths 或 Risks）而捏造不存在的公司事件或數據。

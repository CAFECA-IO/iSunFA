...
export const getJournalPrompt = (accountBook?: IAccountBookBase | null) => {
  ...
  return `
      Current Date: ${today}.
      Analyze the provided receipt/document and extract the information into a highly structured, objective format.${accountBookInfo}${rulesInstruction}
      ...
      Output your notes and the final text in Traditional Chinese, strictly matching the provided JSON schema.`;
};

...
export const getJournalPrompt = (accountBook?: IAccountBookBase | null) => {
  ...
  return `
      ...
      [CRITICAL WARNING]
      You are strictly prohibited from calculating foreign exchange conversions. Do NOT attempt to convert the currency on the receipt to the base currency. You must extract and retain the original currency and amount as printed on the receipt.

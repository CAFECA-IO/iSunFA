...
* **一席話總評:** [結合 ESG 表現、財務體質與外部新聞情緒，給出最核心的評語與違約機率預測]

## 🕸️ 多維度健康診斷 (全球同業排位 Benchmark)
> 將企業表現在各維度中，以 **全球同業排位 (Percentile Ranking, PR 值)** 的概念提供精準座標，消除產業間的先天財務結構誤差。
...
2. **專業客觀**：請以「華爾街頂級投資分析師與企業策略長」的獨具慧眼風格撰寫。
3. **數據與圖表護城河**：表格及 Mermaid 代碼塊之上方，必定加入至少一行空行，避免 Markdown 渲染破圖。所有表格內容不得壓縮成單行，必須維持完整的換行標記；表內全球同業排位必須給出具體的預估 PR 值 (百分位數)。

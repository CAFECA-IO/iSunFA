...
export const AUTH_CHECK: Record<APIName, AuthFunctionsKeysNew[]> = {
  ...
  [APIName.INPUT_CERTIFICATE_CREATE]: [AuthFunctionsKeysNew.user],
  [APIName.INPUT_CERTIFICATE_GET]: [AuthFunctionsKeysNew.user],
  [APIName.INPUT_CERTIFICATE_DELETE]: [AuthFunctionsKeysNew.user],
  [APIName.INPUT_INVOICE_CREATE]: [AuthFunctionsKeysNew.user],
  [APIName.INPUT_INVOICE_UPDATE]: [AuthFunctionsKeysNew.user],
  [APIName.OUTPUT_CERTIFICATE_LIST]: [AuthFunctionsKeysNew.user],
  [APIName.OUTPUT_CERTIFICATE_CREATE]: [AuthFunctionsKeysNew.user],
  [APIName.OUTPUT_CERTIFICATE_GET]: [AuthFunctionsKeysNew.user],
  [APIName.OUTPUT_CERTIFICATE_DELETE]: [AuthFunctionsKeysNew.user],
  [APIName.OUTPUT_INVOICE_CREATE]: [AuthFunctionsKeysNew.user],
  [APIName.OUTPUT_INVOICE_UPDATE]: [AuthFunctionsKeysNew.user],

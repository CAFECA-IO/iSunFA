...
export const AUTH_CHECK: Record<APIName, AuthFunctionsKeysNew[]> = {
  ...
  [APIName.LIST_CERTIFICATE_RC2_INPUT]: [AuthFunctionsKeysNew.user],
  [APIName.CREATE_CERTIFICATE_RC2_INPUT]: [AuthFunctionsKeysNew.user],
  [APIName.GET_CERTIFICATE_RC2_INPUT]: [AuthFunctionsKeysNew.user],
  [APIName.UPDATE_CERTIFICATE_RC2_INPUT]: [AuthFunctionsKeysNew.user],
  [APIName.DELETE_CERTIFICATE_RC2_INPUT]: [AuthFunctionsKeysNew.user],
  [APIName.LIST_CERTIFICATE_RC2_OUTPUT]: [AuthFunctionsKeysNew.user],
  [APIName.CREATE_CERTIFICATE_RC2_OUTPUT]: [AuthFunctionsKeysNew.user],
  [APIName.GET_CERTIFICATE_RC2_OUTPUT]: [AuthFunctionsKeysNew.user],
  [APIName.UPDATE_CERTIFICATE_RC2_OUTPUT]: [AuthFunctionsKeysNew.user],
  [APIName.DELETE_CERTIFICATE_RC2_OUTPUT]: [AuthFunctionsKeysNew.user],

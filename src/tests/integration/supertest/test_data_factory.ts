// Info: (20240701 - Shirley) Test data factory using system default values for real user behavior simulation
import { DefaultValue } from '@/constants/default_value';

export class TestDataFactory {
  // Info: (20240701 - Shirley) Use system default emails and verification codes for testing

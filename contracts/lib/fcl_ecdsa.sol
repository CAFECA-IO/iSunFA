...
library FCL_ecdsa {
    ...
    function ecdsa_precomputed_verify(
        ...
        /* Info: (20260412 - Luphia) Q is pushed via the contract at address Shamir8 assumed to be correct
        ...
        */
        ...
        X = FCL_Elliptic_ZZ.ecZZ_mulmuladd_S8_extcode(
        ...
        return X == 0;
    } // Info: (20260412 - Luphia) end ecdsa_precomputed_verify

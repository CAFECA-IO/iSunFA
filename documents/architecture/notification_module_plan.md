...
**D17 與 D18 的共通點值得記著**：兩者都躲過了單元測試、e2e 與整份 code review。D17 的失效沒有任何觀測量（搖動照舊、徽章照舊、log 乾淨，唯一症狀是「聽不到聲音」）；D18 的失效是「什麼都沒發生」，而沒有人會抱怨一件他不知道應該發生的事。**兩者都是在手動驗收與逐條追問接線時才浮出來的。**

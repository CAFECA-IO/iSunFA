...
| 角色 | 職責 |
|---|---|
| **主講** | EMP005 張文彬（工地主任）。敘事、第一位打卡、切示範模式、投影程式碼 |
...
- [ ] 關閉 `NEXT_PUBLIC_DEMO_ALLOW_MANUAL_COORDINATE`
- [ ] 記錄現場提出的問題 —— 尤其**線形工程圍欄**、**停工日**、**外勤與補登**這三題（計畫書都有對應段落）

**T+1**

- [ ] 處理 `Deprecated:` 標記：手動座標路徑、`DEMO_GEOFENCE_RADIUS_METERS`、`DEMO_ACCOUNT_BOOK_ID`、CSV 欄位標題
